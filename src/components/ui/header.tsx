        ...
        <ul className="flex items-center gap-6">
          ...
          {isLoggedIn && (
            <li className="flex items-center">
              <Link
                href="/messages"
                className="relative text-base hover:text-red-500 transition-colors duration-300 cursor-pointer"
              >
              ...
              <>
                ...
                <li className="flex items-center">
                  <button
                    ...
                    className="text-base hover:text-red-500 transition-colors duration-300 cursor-pointer bg-transparent border-none flex items-center gap-1"
                  >
                    <LogOut size={18} />
                    Sign Out
                  </button>
